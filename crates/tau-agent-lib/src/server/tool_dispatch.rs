...
fn request_variant_name(req: &crate::protocol::Request) -> &'static str {
    ...
    match req {
        ...
        Request::SearchMessages { .. } => "Request::SearchMessages",
        Request::ListMcpPrompts => "Request::ListMcpPrompts",
        Request::GetMcpPrompt { .. } => "Request::GetMcpPrompt",
        Request::CreateSchedule { .. } => "Request::CreateSchedule",
        Request::ListSchedules => "Request::ListSchedules",
